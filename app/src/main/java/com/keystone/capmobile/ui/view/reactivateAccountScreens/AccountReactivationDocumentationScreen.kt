...
import com.keystone.capmobile.databinding.FragmentAccountReactivationDocumentationScreenBinding
import com.keystone.capmobile.util.AppConstants
import com.google.android.material.textfield.TextInputEditText
import pub.devrel.easypermissions.EasyPermissions

class AccountReactivationDocumentationScreen : Fragment(), EasyPermissions.PermissionCallbacks {
    private lateinit var binding: FragmentAccountReactivationDocumentationScreenBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_account_reactivation_documentation_screen,
            container,
            false
        )
    ...
    override fun onResume() {
        ...
        submitButton.setOnClickListener {
            findNavController().navigate(R.id.action_reactivateAccountViewPager_to_accountOpeningSummaryPage)
        }
    }
                    ...
                    AppConstants.getDialog(
                        ...
                        resources.getStringArray(R.array.cameraOrGalleryStringArray),
                        {
                            AppConstants.cameraPermissionHandler(
                                this@AccountReactivationDocumentationScreen,
                                requireContext()
                            ) {
