package com.example.capmobile.ui.view.dialogFragments
...
import com.example.capmobile.databinding.DaoMenuDialogLayoutBinding
import com.example.capmobile.util.AppConstants.PHONE_CALL_PERMISSION_CODE
import com.example.capmobile.util.AppConstants.genericPermissionHandler

class DaoEngageIndividualDialogFragment : DialogFragment() {
        ...
        callTv.setOnClickListener {
            ...
            genericPermissionHandler(
                ...
                val callIntent = Intent(
                    Intent.ACTION_CALL,
                    Uri.parse(
                        "tel: ${Uri.encode(daoToEngage?.phoneNumber)}"
                    )
                )
